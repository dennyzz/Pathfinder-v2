...
echo OpenCV 3.2.0 Raspbian Jessie auto install script - Thomas Cyrix
echo ===============================================================
FILE="/tmp/out.$$"
GREP="/bin/grep"
if [ "$(id -u)" != "0" ]; then
...
echo Receving OpenCV 3.2.0 source...
...
echo Compiling Open CV 3.2.0, may take 2 to 36 hours
make -j4
...
rm -r opencv
echo Completed !
echo You now can use OpenCV 3.2.0 in both Python 2 and Python 3 !
